...
當視覺被門板阻隔後，我們對於「聽覺赤裸」的焦慮反而被放大了。在安靜的空間裡，生理聲響彷彿成為了一種公開的審判，讓我們在原本該放鬆的時刻，反而感到緊繃與羞恥。`,
  ...
  'Art019': {
    title: 'PARO海豹式機器人',
    desc: `這隻叫PARO的海豹機器人，是阿雅最耐心的中文家教，也是讓爺爺誤以為「肚子餓」想拿豆花餵食的小金孫。\n\nPARO 透過觸覺感測與可愛的聲音回饋，能提供一種「非語言」的療癒陪伴。在這個家裡，它不只是冰冷的機器，而是能聽阿雅說話、讓爸爸跟姊姊鬥嘴、激發爺爺照顧本能的「家庭新成員」。`,
    audio: '/audio/voice_paro.mp3'
  },
  'Art003': {
    title: '色盲矯正眼鏡',
  ...
  'Art004': {
    title: '人道救援前線的3D列印機',
    desc: '當道路被炸毀、物流中斷，災區最缺的往往不是食物，而是一個能讓醫療儀器運轉的小零件。\n\n這台列印機展現了救援的新定義：我們不再只能被動等待物資空投，而是透過衛星接收數位藍圖，在地「製造」出止血帶、聽診器零件或水管接頭。它證明了在生死關頭，數據傳輸的速度，就是挽救生命的速度。',
    // audio: '/audio/voice_01.mp3'
  },
  'Art018': {
    title: '爬樓梯的輪椅',
  ...
  'Art010': {
    title: '台語中文翻譯app',
    desc: '爺爺總說「食飽未？」，阿雅總是笑著點頭，姊姊總是只能回單字。\n\n語言的斷層，讓家裡的對話常常停留在最表面的問候。這款 App 不只是翻譯機，它是連結兩代人（甚至跨國籍）的橋樑。當阿雅能聽懂爺爺講古的內容，當姊姊能用流利的台語回應爺爺的關心，科技消除的不只是語言的隔閡，更是心與心之間的距離。',
    // audio: '/audio/voice_01.mp3'
  },
  'Art011': {
    title: '虛擬金孫',
    desc: '姊姊要上課、爸爸要滑手機、阿雅要煮飯... 爺爺滿肚子的話，該說給誰聽？\n\n這個投射在平板或全息投影上的「虛擬金孫」，擁有記憶功能與情感運算引擎。它不會嫌爺爺囉唆，記得爺爺講過的每一個老故事，還會提醒吃藥。雖然它是虛擬的，但它提供的「被重視感」卻是真實的。這不禁讓我們反思：在忙碌的現代生活中，我們是否只能依賴科技，來替我們履行那些無法時刻在場的陪伴？',
    // audio: '/audio/voice_01.mp3'
  },
  'Art012': {
    title: '衛生棉地圖',
    desc: '「那個突然來了...怎麼辦？」這是每位女性在城市移動時，都曾有過的深層焦慮。\n\n當生理期意外造訪，或者囊中羞澀時，這份地圖就是最即時的救援。它標示了城市中提供生理用品的友善據點（公共廁所、學校、友善店家）。這項科技想說的是：月經不該是令人驚慌的秘密，城市應該溫柔地接住每一位女性的生理需求，讓「找衛生棉」不再是一場尷尬的冒險。',
    // audio: '/audio/voice_01.mp3'
  },
  'Art013': {
    title: '老人防摔背心',
...
function WallText() {
  ...
  return (
    ...
    // 這裡設在原本兩個位置的中間點附近
    <group position={[32, 13, 49]} rotation={[0, 0, 0]}>
